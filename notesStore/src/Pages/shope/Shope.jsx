...
const Shope = () => {
  ...
  const filterItems =
    activeButton === "all"
      ? filteredBooks
      : filteredBooks.filter((item) => item.category === activeButton);
      ...
      <div className="container shope-container">
        ...
        <div className="showcase">
          <div className="side-bar">
            <div className="sortBy">
              ...
              >
                ...
                <option className="select-option" value="priceLowToHigh">
                  Price: Low to High
                </option>
                <option className="select-option" value="priceHighToLow">
                  Price: High to Low
                </option>
          ...
          <div className="gallery">
            {sortedItems
              .slice(0, 8)
              .map(({ name, writer, price, image }, index) => {
                return (
